import { Block, Button, Link, Navbar, Page, Panel } from 'framework7-react';
		...
		<Page id="panel-page">
			...
			>
				<p>
					...
					are optional. You can put absolutely anything inside: data
					lists, forms, custom content, and even other isolated app
